...
mode**. Read `BOOTSTRAP.md` immediately and execute the bootstrap skill at
`yidam/prelude/skills/bootstrap.md` from start to finish before responding to any user
message or matching any other skill or workflow.
