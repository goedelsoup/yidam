...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      // Two sources rather than one: the mark is monochrome ink, and an <img> cannot
      // inherit the page's theme, so the dark header needs its own file. Starlight picks
      // between them; both are generated by `mise run mark-generate`.
      logo: {
        light: './src/assets/logo-mark.svg',
