...
mod tests {
    ...
    fn allen_county(phase_commits: usize) -> Measurement {
        Measurement {
            ...
            // Zero, not because the repository has none, but because #673's suffix breakdown
            // is a clause appended to a question and these assertions are about the number in
            // front of it. A non-zero count would exercise that clause and say nothing about
            // rendering.
            suffixed_commits: 0,
            nodes: 683,
