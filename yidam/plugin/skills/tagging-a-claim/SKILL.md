...
- **An edge cannot outrank what it relates.** `edge-standing-unheld` reports an edge asserting
  a standing stronger than one its endpoints declare — `verified` between two nodes graded
