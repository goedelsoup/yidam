...
`head_commit_short(root)` ([`head_commit_short`](../../yidam/cli/src/model.rs#L276)) — `git
...
([`checks.rs:94-111`](../../yidam/cli/src/cmd/lint/checks.rs#L94-L111)). `unlicensed-edge`
...
- **Not licensed by `edge_policy`.** `unlicensed-edge`'s own rationale draws this line
  already ([`checks.rs:1461-1462`](../../yidam/cli/src/cmd/lint/checks.rs#L1461-L1462)): *a link to the
