...
([`checks.rs:627-644`](../../yidam/cli/src/cmd/lint/checks.rs#L627-L644)). `unlicensed-edge`
...
- **Not licensed by `edge_policy`.** `unlicensed-edge`'s own rationale draws this line
  already ([`checks.rs:1772-1774`](../../yidam/cli/src/cmd/lint/checks.rs#L1772-L1774)): *a link to the
