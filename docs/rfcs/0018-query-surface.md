...
([`unknown-class`](../../yidam/cli/src/cmd/lint/checks.rs#L816), Error), the properties it may
and must carry ([`undeclared-property`](../../yidam/cli/src/cmd/lint/checks.rs#L1055),
[`missing-property`](../../yidam/cli/src/cmd/lint/checks.rs#L1205)), the type of each value
([`property-type`](../../yidam/cli/src/cmd/lint/checks.rs#L1450)), which relationships a class
licenses ([`unlicensed-edge`](../../yidam/cli/src/cmd/lint/checks.rs#L1510)), and which class
each relationship may land on
([`edge-target-class`](../../yidam/cli/src/cmd/lint/checks.rs#L1575), Error).

`unlicensed-edge`'s own rationale states the gap in as many words
([`checks.rs:1560`](../../yidam/cli/src/cmd/lint/checks.rs#L1560)):
