...
[`dep_nodes`](../../yidam/cli/src/cmd/serve/mod.rs#L80) is a separate field by deliberate design.
...
[`qualified_id`](../../yidam/cli/src/model.rs#L418) renders `pkg::class/name` and is the only
...
[`resolve_link_target`](../../yidam/cli/src/model.rs#L435) resolves an on-disk edge from a
...
|---|---|---|---|
| `class/name` | [`corpus_nodes`](../../yidam/cli/src/model.rs#L462-L485) | — | — |
| `pkg::class/name` | [`qualified_id`](../../yidam/cli/src/model.rs#L418) | yes | — |
| `.yidam/corpus/class/name.yml` | tolerated by [`find_node`](../../yidam/cli/src/cmd/serve/tools.rs#L351) | — | — |
| `../other-class/thing.yml` | [`resolve_link_target`](../../yidam/cli/src/model.rs#L435) | — | — |
...
tolerated spellings, [`qualified_id`](../../yidam/cli/src/model.rs#L418),
