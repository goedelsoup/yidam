...
```sh
cargo install --git https://github.com/goedelsoup/yidam --tag cli/v0.14.0 --locked \
...
```sh
open yidam-0.14.0-aarch64-apple-darwin.mcpb    # Apple silicon
open yidam-0.14.0-x86_64-apple-darwin.mcpb     # Intel
```
...
The version is the CLI's own: `yidam-0.14.0-…` carries `yidam 0.14.0`. A bundle installed six
