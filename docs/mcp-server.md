...
```sh
cargo install --git https://github.com/goedelsoup/yidam --tag cli/v0.13.0 --locked \
...
```sh
open yidam-0.13.0-aarch64-apple-darwin.mcpb    # Apple silicon
open yidam-0.13.0-x86_64-apple-darwin.mcpb     # Intel
```
...
The version is the CLI's own: `yidam-0.13.0-…` carries `yidam 0.13.0`. A bundle installed six
